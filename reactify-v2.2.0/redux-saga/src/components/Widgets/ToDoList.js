    ...
    render() {
        return (
            <Fragment>
                ...
                <PerfectScrollbar style={{ height: 'auto' , minHeight : '100px' ,maxHeight : '420px' }}>
                    <List className="p-0">
                            ...
                            <ListItem className="border-bottom" button key={key} onClick={() => this.handleChange(!data.completed, data)}>
                                <div className={classnames('d-flex justify-content-between align-items-center w-100', { 'strike': data.completed })}>
                                    ...
                                    <div className="hover-action">
                                        <Button className="btn-danger text-white" variant="fab" mini= "true" onClick={(e) => this.onDeleteTask(e, data)}><i className="zmdi zmdi-delete"></i></Button>
                                    </div>
                                </div>
                            </ListItem>
                        ))}
