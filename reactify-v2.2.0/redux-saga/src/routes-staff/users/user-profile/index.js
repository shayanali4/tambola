...
// 											<Button mini= "true" variant="fab" className="btn-facebook text-white">
// 												<i className="zmdi zmdi-facebook"></i>
// 											</Button>
// 										</li>
// 										<li className="list-inline-item">
// 											<Button mini= "true" variant="fab" className="btn-twitter text-white">
// 												<i className="zmdi zmdi-twitter"></i>
// 											</Button>
// 										</li>
// 										<li className="list-inline-item">
// 											<Button mini= "true" variant="fab" className="btn-google text-white">
// 												<i className="zmdi zmdi-google"></i>
// 											</Button>
// 										</li>
// 										<li className="list-inline-item">
// 											<Button mini= "true" variant="fab" className="btn-linkedin text-white">
// 												<i className="zmdi zmdi-linkedin"></i>
// 											</Button>
// 										</li>
// 										<li className="list-inline-item">
// 											<Button mini= "true" variant="fab" className="btn-youtube text-white">
