...
class FootfallChart extends Component {
  state = {
    ...
    componentDidMount()
    {
       ...
       let modulename = this.props.branchid + '_memberfootfall';
      ...
      if(data)
      {
        let memberfootfalldata = data.memberfootfalldata;
        ...
        this.showchartData(memberfootfalldata);
      }
      else {
    ...
    getDashboardBiometricAndQRCodeChartData({date})
    {
      ...
      api.post('dashboard-footfall-chart',{date,attendancetype,branchid,client_timezoneoffsetvalue})
     .then(response =>
       {
         attendancetype = '1';
        ...
        .then(response =>
          {
            ...
            let memberfootfalldata = concateddata;
            chartdata.memberfootfalldata = memberfootfalldata;
          ...
          //  this.getDashboardChartData(concateddata);
          }
    ...
    showchartData(data)
      {
            ...
            // let branchid =  this.props.branchid;
              ...
              //  api.post('dashboard-footfall-chart',{date,attendancetype,branchid})
              // .then(response =>
              //   {
                  let  datasets = [
                     {
...
export default connect(mapStateToProps)(FootfallChart);
