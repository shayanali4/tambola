...
import BookTicketList from './component/BookTicketList';
...
export default class BookTicket extends Component {
	...
	render() {
		...
		return (
			<div>
			<PageTitleBar
							title={<IntlMessages id="sidebar.bookTicket" />}
							match={this.props.match}
						/>

						<RctCollapsibleCard fullBlock>
							<BookTicketList history = {this.props.history} location = {this.props.location}/>
						 </RctCollapsibleCard>
