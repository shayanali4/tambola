	...
	render() {
		...
		return (
			<div className="blog-list-wrap">
				...
				<PerfectScrollbar style={{ height: 'auto' , minHeight : '100px' ,maxHeight : '600px' }}>
					<List className="p-0">
						{this.state.blogPostData && this.state.blogPostData.map((data, key) => (
							<ListItem key={key} button className="post-item align-items-center justify-content-between py-25">
								...
								<div className="d-flex hover-action">
									<Button className="btn-success text-white m-5" variant="fab" mini= "true" onClick={() => this.onEditPost(data)}>
										<i className="zmdi zmdi-edit"></i>
									</Button>
									<Button className="btn-danger text-white m-5" variant="fab" mini= "true" onClick={(e) => this.onDeletePost(e, data)}>
