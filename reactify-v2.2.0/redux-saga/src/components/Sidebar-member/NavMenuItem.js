...
class NavMenuItem extends PureComponent {
    ...
    render() {
        const { menu, onToggleMenu,clienttypeId } = this.props;
        ...
        return (
            <ListItem button component="li">
                <NavLink activeClassName="item-active" to={menu.path}>
                    ...
                    <span className="menu">
                        {(menu.path == "/member-app/preset-schedule" ||  menu.path == "/member-app/preset-diet" )?
                           <IntlMessages id={clienttypeId != 1 ? menu.menu_title : menu.menu_title1 } />
                           :
                           <IntlMessages id={menu.menu_title} />
                         }
                      </span>
