		...
		<div className="button-wrapper">
			...
			<div className="row">
				...
				>
					...
					<MatButton variant="fab" mini= "true" color="primary" className="text-white mr-15 mb-10" aria-label="add">
						<i className="zmdi zmdi-settings"></i>
					</MatButton>
					<MatButton variant="fab" className="btn-danger text-white mr-15 mb-10" aria-label="add">
						<i className="zmdi zmdi-favorite"></i>
					</MatButton>
					<MatButton variant="fab" mini= "true" className="btn-danger text-white mr-15 mb-10" aria-label="add">
						<i className="zmdi zmdi-favorite"></i>
					</MatButton>
					...
					<MatButton variant="fab" mini= "true" disabled className="btn-info text-white mr-15 mb-10" aria-label="add">
						<i className="zmdi zmdi-help-outline"></i>
					</MatButton>
				</RctCollapsibleCard>
				<RctCollapsibleCard
