...
const PricingBlockV1 = ({ planType, type, description, price, users,employees, features, color, buttonText }) => (
   <RctCollapsibleCard customClasses="text-center" colClasses="col-md-4">
      ...
      <div className="mb-25">
         ...
         <span className="text-muted small">For {employees} employee</span>
