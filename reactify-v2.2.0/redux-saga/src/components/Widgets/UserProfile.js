            ...
            <div className="user-profile-widget">
                ...
                <div className="p-20">
                    ...
                    <div className="d-flex">
                        <Button variant="contained" color="primary" className="text-white mr-10 mb-10 btn-xs"><IntlMessages id="button.viewProfile" /></Button>
                        <Button variant="contained" color="secondary" className="text-white btn-xs mb-10">
