	...
	<div className="rct-footer d-flex justify-content-between align-items-center">
		<ul className="list-inline footer-menus mb-0">
			<li className="list-inline-item">
				<Button component={Link} to="/app/dashboard/master-dashboard"><IntlMessages id="sidebar.gettingStarted" /></Button>
			</li>
			<li className="list-inline-item">
						<Button >					<a href={AppConfig.brandUrl} style ={{color : "black"}} target = "_blank">
			...
			<li className="list-inline-item">
				<Button component={Link} to="/app/terms-condition"><IntlMessages id="sidebar.terms&Conditions" /></Button>
			</li>
			<li className="list-inline-item">
				<Button component={Link} to="/app/users/feedback"><IntlMessages id="sidebar.feedback" /></Button>
			</li>
			<li className="list-inline-item">
