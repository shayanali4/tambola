              ...
              <li key={key}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div className="hover-action text-right w-25 align-self-center">
                    <Button color="primary" className="text-white mr-5 mb-5" variant="fab" mini= "true" onClick={() => this.onViewEmal(email)}><i className="zmdi zmdi-eye"></i></Button>
                    <Button className="btn-danger text-white mr-5 mb-5" variant="fab" mini= "true" onClick={() => this.onDeleteEmail(email)}><i className="zmdi zmdi-delete"></i></Button>
                    <Button className="btn-success text-white mr-5 mb-5" variant="fab" mini= "true" onClick={() => this.showReplyTextBox(email)}><i className="zmdi zmdi-mail-reply"></i></Button>
                  </div>
                </div>
              </li>
            ))}
