module.exports = {
	...
	"sidebar.productlist": "Product",
	"sidebar.equipment": "Equipment",
	"sidebar.brands": "Equipment Brand",
	"sidebar.equipmentlibrary": "Equipment Library",
	"sidebar.equipmentpurchased": "Equipment Invoice",
	"sidebar.equipmentinstock": "Equipment In-Stock",
	"sidebar.broadcast": "Broadcast",
	"sidebar.enquiry": "Enquiry",
	"sidebar.visitorbook": "Visitor Book",
	"sidebar.classes": "Classes",
	"sidebar.manageclass" : "Manage Class",
	"sidebar.manageClass" : "Manage Class",
	"sidebar.classSchedules" : "Class Schedule",
	"sidebar.expressSale" : "Express Sale",
	"sidebar.storeCategory" : "Store Category",
	"sidebar.store" : "Store",
	"sidebar.dealType" : "Deal Type",
	"sidebar.deal" : "Deal",
	"sidebar.game" : "Game",
	"sidebar.bookTicket" : "Book Ticket",
	"sidebar.mySales" : "My Sales",
	"sidebar.changeSale" : "Change Sale",
	"sidebar.changesale" : "Change Sale",
  "sidebar.memberFeedback": "Feedback",
	"sidebar.inductionChecklist": "Induction Checklist",
	"sidebar.memberApp": "App",
	"sidebar.membership" : "Membership",
	"sidebar.buy-service" : "Buy Services",
	"sidebar.class-schedule" : "Class Schedule",
	"sidebar.attendedSession" : "Attended Session",
	"sidebar.home" : "Home",
	"sidebar.fitness-tracking" : "Fitness Tracking" ,
	 "sidebar.timeline" : "Timeline",
	"sidebar.changePassword" : "Change Password",
	"sidebar.presetSchedule" : "Pre Set Workout",
	"sidebar.workoutPlan" : "Workout Plan",
	"sidebar.memberexercise" : "Exercise Library",
	"sidebar.recipeLibrary" : "Food Library",
	"sidebar.gymAccessslot" : "Gym Access Slot",
	"sidebar.pt-schedule" : "PT Schedule",
	"sidebar.bodyProgress" : "Body Progress",
	"sidebar.rewardPoints" : "Reward Points",
	"sidebar.progressPhotos" : "Progress Photos",
	"sidebar.history" : "History",
	"sidebar.expenseManagement": "Invt. & Exp.",
	"sidebar.expenses" : "Expenses",
	"sidebar.investment" : "Investment",
	"sidebar.staffPay" : "Staff Pay",
	"sidebar.classAttendance" : "Class Attendance",
	"sidebar.classPerformance" : "Class Performance",
	"sidebar.zone" : "Zone",
	...
	"sidebar.termsCondition": "Terms & Conditions",
	"sidebar.feedback": "Feedback",
	"sidebar.myPerformance": "My Performance",
	...
	"sidebar.personalTraining" : "Personal Training",
	"sidebar.PT" :"PT & Diet",
	"sidebar.pt" :"PT & Diet",
	"sidebar.memberManagement" : "Member Management",
	"sidebar.memberfeedback" : "Member Feedback",
	"sidebar.inactiveMembers" : "Inactive Members",
	"sidebar.dues" :"Payment Dues",
	"sidebar.measurement" :"Measurement",
	"sidebar.biometric" : "Biometric",
	"sidebar.covid19disclaimer" :"COVID-19 Disclaimer",
  "sidebar.configuration" :"Configuration",
	"sidebar.memberdisclaimer" :"Member Disclaimer",
	"sidebar.staffdisclaimer" :"Staff Disclaimer",
    "sidebar.memberDisclaimer" :"Member Disclaimer",

	"sidebar.setting" :"Settings",
	"sidebar.report" : "Report",
	"sidebar.collectionReport" : "Collection Report",
	"sidebar.duesReport" : "Dues Report",
	"sidebar.onlinepayment" :"Online Payment",
	"sidebar.soldProduct" : "Sold Product",
	"sidebar.soldService" : "Sold Service",
	"sidebar.memberAttendancereport" : "Member Attendance",
	"sidebar.employeeAttendancereport" : "Staff Attendance",
	"sidebar.classAttendancereport" : "Class Attendance",
	"sidebar.ptAttendancereport" : "PT Attendance",
	"sidebar.enquiryFollowupreport" : "Enquiry Followup ",
	"sidebar.memberFollowupreport" : "Member Followup",
	"sidebar.activeMembershipreport" : "Active Subscription",
	"sidebar.membershipreport" : "Subscription History",
	"sidebar.notification" : "Notification Report",
	"sidebar.gymAccessSlotreport" : "Gym Access Slot",
	"sidebar.visitorbookReport" : "Visitor Book History",
	"sidebar.organization" :"Organization",
	"sidebar.advertisement" :"Advertisement",
	"sidebar.resultandtestimonial" :"Result And Testimonial",
	"sidebar.poster" :"Poster",
	"sidebar.memberProfile" : "Member Profile",
	"sidebar.trainingProfile" : "Member Profile",
	"sidebar.templateConfiguration" : "Notification",
	"sidebar.branding" : "Branding",
	"sidebar.integration" : "Integration",
	"sidebar.budget" : "Budget",
	"sidebar.disclaimer" :"Disclaimer",
	"sidebar.role" : "Role",
	"sidebar.pendingCheque" : "Pending Cheque",
	"sidebar.workoutSchedule" : "Allocate Workout",
	 "sidebar.allocateDiet" : "Allocate Diet",
	"sidebar.ptAttendence" : "PT Attendance",
	"sidebar.memberPt" : "PT Attendence",
	"sidebar.memberPersonaltraining" : "Personal Training",
	"sidebar.ptSchedule" : "PT & Diet Schedule",
	"sidebar.ptRoom" : "PT Room",
	"sidebar.memberAttendance" : "Member Attendance",
	"sidebar.masterdata":"Master Data",
	"sidebar.workouts" :"Workouts",
	"sidebar.workoutRoutine" :"Workout Routine",
	"sidebar.workoutPlan" :"Workout Plan",
  "sidebar.diets" : "Diets",
  "sidebar.recipe" : "Foods",
	"sidebar.dietRoutine" : "Diet Routine ",
	"sidebar.presetDiet" : "Pre Set Diet",
	"sidebar.dietPlan" : "Diet Plan",
	"sidebar.exercise" :"Exercise",
	"sidebar.users": "Staff",
	"sidebar.profileSetting": "Profile Setting",
	"sidebar.userProfile1": "User Profile 1",
	"sidebar.userProfile2": "User Profile 2",
	"sidebar.userManagement": "User Management",
	"sidebar.employeeManagement": "Manage Staff",
	"sidebar.manageshift": "Manage Shift",
	"sidebar.assignshift": "Assign Shift",
	"sidebar.staffAttendance" : "Staff Attendance",
	"sidebar.userProfile": "User Profile",
	"sidebar.userProfileview": "User Profile View",
	...
	"widgets.categorywiseexpense": "Category Wise Expense",
	"widgets.bills": "Bills",
	"widgets.maintenance": "Maintenance",
	"widgets.servicewisesell": "Service Wise Sell",
	"widgets.productwisesell": "Product Wise Sell",
	"widgets.bodypartbreakdown": "Body part breakdown",
	"widgets.nutritionbreakdown": "Nutrition breakdown",
	"widgets.waterdrinkreport": "Water Drink Report",
	...
	"themeOptions.lightMode": "Light Mode",
	...
	"sidebar.saas": "SAAS",
	"sidebar.masterDashboard" : "Master Dashboard",
	"sidebar.followupDashboard" : "Followup Dashboard",
	"sidebar.followupAnalysis" : "Followup Analysis",
	"sidebar.revenueDashboard" : "Revenue Dashboard",
	"sidebar.budgetDashboard" : "Budget Dashboard",
	"sidebar.memberDashboard" : "Member Dashboard",
	"sidebar.staffPerformance" : "Staff Performance",
	"sidebar.multiLevel": "MultiLevel",
	"sidebar.level1": "Level 1",
	"sidebar.level2": "Level 2",
	"sidebar.renewalAnalysis" : "Renewal Analysis",
	"sidebar.conversionAnalysis" : "Conversion Analysis",
}
